...
function PredictionType() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 text-white lg:grid-cols-2 justify-center gap-5 px-5 md:px-10 xl:px-[100px]">
      <div className="bg-[#14121a] rounded-[8px]  flex flex-col lg:flex-row justify-between items-center gap-3 sm:gap-4 w-full font-work lg:pr-3">
