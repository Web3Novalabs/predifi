...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Join the Waitlist | PrediFi — Early Access to Web3 Prediction Markets",
    description:
      "Join the PrediFi waitlist and be among the first to access the next generation of decentralized prediction markets built on the Stellar blockchain.",
    url: "https://predifi.app/waitlist",
    siteName: "PrediFi",
    images: [{ url: "https://predifi.app/logo.jpeg", width: 1200, height: 630, alt: "PrediFi Waitlist" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
