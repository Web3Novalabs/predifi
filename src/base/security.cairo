...
pub trait SecurityTrait<TContractState> {
    ...
    fn assert_amount_within_limits(
        self: @TContractState, amount: u256, min_amount: u256, max_amount: u256,
    );
    ...
    fn assert_sufficient_balance(
        self: @TContractState, token: IERC20Dispatcher, user: ContractAddress, amount: u256,
    );
    ...
    /// @param amount The required amount
    fn assert_sufficient_allowance(
        self: @TContractState,
    ...
    fn assert_pool_creation_fee_requirements(
        self: @TContractState,
        token: IERC20Dispatcher,
    ...
    fn assert_valid_pool_timing(
        self: @TContractState, start_time: u64, lock_time: u64, end_time: u64,
    );
    ...
    fn assert_valid_pool_option(
        self: @TContractState, option: felt252, option1: felt252, option2: felt252,
    );
