...
fn test_create_pool_rejects_non_whitelisted_token() {
    ...
    client.create_pool(
        ...
        &CreatePoolParams {
            end_time: 100000u64,
            token: token_not_whitelisted.clone(),
            options_count: 2u32,
...
fn test_create_pool_rejects_excess_options_count() {
    ...
    client.create_pool(
        ...
        &CreatePoolParams {
            end_time: 100_000u64,
            token: token_address.clone(),
            options_count: 101u32,
            description: String::from_str(&env, "Too many options"), // so 101 is invalid
...
fn test_create_pool_rejects_max_stake_less_than_min_stake() {
    ...
    client.create_pool(
        ...
        &CreatePoolParams {
            ...
            max_stake: // min_stake
        50i128,
            initial_liquidity: // max_stake < min_stake → invalid
        0i128,
            category: Symbol::new(&env, "Tech"),
            private: false,
            whitelist_key: None,
...
fn test_create_pool_accepts_max_stake_equal_to_min_stake() {
    ...
    let pool_id = client.create_pool(
        ...
        &CreatePoolParams {
            ...
            max_stake: // min_stake
        100i128,
            initial_liquidity: // max_stake == min_stake → valid
        0i128,
            category: Symbol::new(&env, "Tech"),
            private: false,
            whitelist_key: None,
...
fn test_resolve_pool_rejects_out_of_bounds_outcome() {
    ...
    let pool_id = client.create_pool(
        ...
        &CreatePoolParams {
            end_time: 100_000u64,
            token: token_address.clone(),
            options_count: 3u32, // outcomes 0, 1, 2
