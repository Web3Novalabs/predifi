...
fn test_full_market_lifecycle() {
    ...
    let pool_id = client.create_pool(&CATEGORY_SPORTS, &end_time, &token_ctx.token_address, &String::from_str(&env, "Test Pool"), &String::from_str(&env, "ipfs://bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi"));
...
fn test_multi_user_betting_and_balance_verification() {
    ...
    let pool_id = client.create_pool(&CATEGORY_SPORTS, &2000u64, &token_ctx.token_address, &String::from_str(&env, "Test Pool"), &String::from_str(&env, "ipfs://bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi"));
...
fn test_market_resolution_multiple_winners() {
    ...
    let pool_id = client.create_pool(&CATEGORY_SPORTS, &1500u64, &token_ctx.token_address, &String::from_str(&env, "Test Pool"), &String::from_str(&env, "ipfs://bafybeigdyrzt5sfp7udm7hu76uh7y26nf3efuylqabf3oclgtqy55fbzdi"));
